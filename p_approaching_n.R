...
hist_lambdas
ggsave("hist_lambdas_2.pdf", plot = hist_lambdas, width = 6, height = 4)
...
ggsave("box_plot_F1_2.pdf", plot = box_plot_F1, width = 6, height = 4)
...
ggsave("box_plot_CI_Total_2.pdf", plot = box_plot_CI_Total, width = 6, height = 4)
...
ggsave("box_plot_CI_Act_2.pdf", plot = box_plot_CI_Act, width = 6, height = 4)
...
ggsave("box_plot_CI_Inact_2.pdf", plot = box_plot_CI_Inact, width = 6, height = 4)
